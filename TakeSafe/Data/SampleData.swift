...
struct SampleData {
    static let drug = Drug(id: "caffeine", name: "Caffeine", aliases: ["Guaranine", "Methyltheobromine", "1,3,7-Trimethylxanthine"], description: "Caffeine is a central nervous system stimulant of the methylxanthine class. It is the world’s most widely consumed psychoactive drug.", learnMoreUrl: URL(string: "https://en.wikipedia.org/wiki/Caffeine")!, icon: .energy, drugClass: .stimulant, dependence: .low, addiction: .low, onset: 1.0, duration: 4.0, massUnit: .milligrams, ld50: LD50(value: 192, unitDividend: .milligrams, unitDivisor: .kilograms, animal: "rat", route: "oral"), defaultDose: 100, doseStep: 50, commonDoses: [100, 200], administrationRoutes: [AdministrationRoute(id: "oral", bioavailability: 99), AdministrationRoute(id: "insufflation", bioavailability: 99), AdministrationRoute(id: "enema", bioavailability: 99), AdministrationRoute(id: "rectal", bioavailability: 99), AdministrationRoute(id: "intravenous", bioavailability: 100)], rdi: 400, interactions: nil, warnBeforeBedtime: 6, legality: nil)
