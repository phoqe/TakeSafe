...
struct SampleData {
    static let drug = Drug(id: "caffeine", name: "Caffeine", aliases: ["Guaranine", "Methyltheobromine", "1,3,7-Trimethylxanthine"], description: "Caffeine is a central nervous system stimulant of the methylxanthine class. It is the world’s most widely consumed psychoactive drug.", learnMoreUrl: URL(string: "https://en.wikipedia.org/wiki/Caffeine")!, icon: "Energy", drugClass: .stimulant, dependence: .low, addiction: .low, onset: 1.0, duration: 4.0, massUnit: .milligrams, ld50: LD50(value: 192, unitDividend: .milligrams, unitDivisor: .kilograms, animal: "rat", route: "oral"), defaultDose: 100, doseStep: 50, commonDoses: [100, 200], administrationRoutes: [AdministrationRoute(id: "oral", bioavailability: Bioavailability(start: 99, end: 99), duration: nil), AdministrationRoute(id: "insufflation", bioavailability: Bioavailability(start: 99, end: 99), duration: nil), AdministrationRoute(id: "enema", bioavailability: Bioavailability(start: 99, end: 99), duration: nil), AdministrationRoute(id: "rectal", bioavailability: Bioavailability(start: 99, end: 99), duration: nil), AdministrationRoute(id: "intravenous", bioavailability: Bioavailability(start: 99, end: 99), duration: nil)], rdi: 400, interactions: nil, warnBeforeBedtime: 6, legality: nil, addictionProfile: "", sentenceName: "caffeine", metabolites: ["2-Oxo-3-hydroxy-LSD"])
    static let activeDrug = ActiveDrug(drug: drug, dose: 200, ingestion: Date().addingTimeInterval(TimeInterval(-6000)), administrationRoute: AdministrationRoute(id: "oral", bioavailability: Bioavailability(start: 99, end: 99), duration: nil))
